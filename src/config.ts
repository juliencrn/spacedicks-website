...
export const contractAddress =
  ...
  "0xab5c942A448Bcd94d5e48bBd884f293816d58Ce5";
...
export const NETWORK = process.env.NEXT_PUBLIC_NETWORK || "mainnet"; // "mumbai";
export const openSeaCollectionUrl =
  process.env.NEXT_PUBLIC_OPENSEA_LINK ||
  "https://opensea.io/collection/spacedicks";
export const openSeaTokenBaseUrl =
  NETWORK === "mainnet"
